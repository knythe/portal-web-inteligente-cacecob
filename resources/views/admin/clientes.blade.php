...
<div class="w-full overflow-hidden rounded-lg shadow-xs">
    <div class="w-full overflow-x-auto">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div class="w-full md:w-3/12 flex justify-end">
                <div class="flex items-center space-x-3 w-full md:w-auto">
                   ...
                   dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
                    ...
                    <!-- Dropdown con estados dinámicos -->
                        ...
                        <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                            ...
                            <li class="flex items-center">
                                <input
                                    ...
                                    class="cliente-filter w-4 h-4 text-black border-gray-300 rounded focus:ring-black checked:bg-black checked:border-black dark:bg-gray-700 dark:border-gray-500 dark:checked:bg-black dark:checked:border-black">
            ...
            <div class="w-full md:w-3/12 flex justify-end">
                <div class="flex items-center space-x-3 w-full md:w-auto">
                    <a href="{{ route('export-excel-cliente') }}"
