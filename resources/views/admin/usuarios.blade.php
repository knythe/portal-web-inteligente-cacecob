                        ...
                        <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                            ...
                            <li class="flex items-center">
                                <input
                                    ...
                                    class="user-filter w-4 h-4 text-black border-gray-300 rounded focus:ring-black checked:bg-black checked:border-black dark:bg-gray-700 dark:border-gray-500 dark:checked:bg-black dark:checked:border-black">
