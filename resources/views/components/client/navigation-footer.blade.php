        ...
        <div class="ji gp">
            <div class="tc uf ap gg fp">
                <div class="animate_top zd/2 to/4">
                    <a href="index.html">
                        <img src="/assets/img/logo.svg" alt="Logo" class="om" />
                        <img src="images/logo-dark.svg" alt="Logo" class="xc nm" />
                    </a>

                    <p class="lc fb text-justify">Diplomados y cursos especializados con valor académico, dictados por expertos y certificados por la Universidad Nacional de Piura.</p>
                ...
                <div class="animate_top zd/2 to/4">
                    <img src="/assets/img/1.jpg" width="300px">
                </div>
                <div class="animate_top zd/2 to/4">
